  ...
  >
    <template #item="{ element }">
      ...
      >
        ...
        <div
          v-if="allowsChildren(element.type)"
        ...
        >
          <component
            ...
            v-bind="{
              ...
              renderColumn: element.type === 'grid' ? (colIndex) => renderGridColumn(element, colIndex) : undefined
            }"
            :id="element.htmlId"
...
// Handle drop inside container/grid
...
const renderChildren = (parentBlock: Block) => {
  ...
  // Use current component instance for recursion
...
// Render grid column with drop zone
const renderGridColumn = (gridBlock: Block, columnIndex: number) => {
  ...
  return h(
    'div',
    {
      class: 'grid-column-dropzone w-full',
      onDrop: (e: DragEvent) => onDropInGridColumn(e, gridBlock, columnIndex),
      onDragover: (e: Event) => e.preventDefault(),
      onDragenter: (e: Event) => e.preventDefault()
    },
    columnBlocks.length > 0
      ? h(BlockRendererComponent as any, {
          blocks: columnBlocks,
          selectedId: props.selectedId,
          isPreview: props.isPreview,
